...
export default {
    ...
    methods: {
        fetchBookDetails(id) {
            this.isLoading = true;
            axios
                .get(`http://localhost:3000/api/buku/${id}`)
                .then((response) => {
                    ...
                    if (bookData) {
                        this.book = {
                            ...
                            category: bookData.category || 'Tanpa Kategori',
        ...
        handleBorrowSubmit(receipt) {
            ...
            this.receiptData = {
                nomor_resi: receipt.kartu_pustaka.nomor_resi,
                judul_buku: this.book.title,
                tanggal_pinjam: receipt.peminjaman.tanggal_pinjam,
                tanggal_kembali: receipt.peminjaman.tanggal_kembali,
                status: receipt.peminjaman.status,
            };
